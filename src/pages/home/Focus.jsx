    ...
    <React.Fragment>
        ...
        <div className=' md:flex-row md:items-center md:justify-evenly py-2  flex flex-col items-center gap-7 px-3 '>
            <section className=' w-fit relative '>
                ...
                <img src={image1} loading="lazy"  alt="" className=' min-[430px]:w-80 min-[560px]:w-[390px] w-64 md:w-72  rounded-md' loading='lazy' />
            </section>
            <section className=' w-fit relative '>
                ...
                <img src={image3} loading="lazy"  alt="" className=' min-[430px]:w-80 min-[560px]:w-[390px] w-64 md:w-72  rounded-md' loading='lazy' />
            </section>
            <section className=' w-fit relative '>
                ...
                <img src={image2} loading="lazy"  alt="" className=' min-[430px]:w-80 min-[560px]:w-[390px] w-64 md:w-72  rounded-md' loading='lazy' />
            </section>
        </div><br />
    </React.Fragment>
  )
